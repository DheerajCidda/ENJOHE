...
<div class="font1" align="center">
     <div align="center" class="strip1" style="text-align: center; font-size: 20pt; padding-top: 3px; width: 500px; height:60px;"><p style="margin-top:5px;">Find a Job</p></div>
			<div align="center" style="width: 1000px; text-align:justify;"> <br>The table below is an overall view of engineering/technology jobs in healthcare. The unique multi-dimensional mega-menu design allows both employers and job seekers to see all their choices in one glance. The purposes are to direct employers to enter job data into the right categories, to enable job seekers to quickly find dream jobs, and to facilitate employers to easily identify qualified candidates and access their resumes. This proves to be a highly efficient and user-friendly job search mechanism.
</div>
                </div>

<div align="center">

<div class="font1"  style="background:rgba(0,120,125,1.00); color: white;
    margin-top: 40px;
    text-align: center;
	...
	width: 500px;
            ...
            <p>Job seeker: <br>In the table below, select those best describe your interest
<br>and qualifications.</p></div>
		
         
<!-- Starting of table  #D1D1D1; -->
<div class="font1">
...
<div class="font1">
	<div align="center">
    <div style="background:rgba(0,120,125,1.00); color:white;margin-top: 40px; text-align: center; display: inline-block; font-size: 14pt;border: 2px solid rgb(0,107,130);
    	       border-radius: 8px; width: 500px; box-shadow: inset 2px 2px 2px rgba(255, 255, 255, .4), inset -2px -2px 2px rgba(0, 0, 0, .4);"> 
               <p style="padding-top: 10px;"> Jobseeker: <br> Provide more details about your interest and <br>qualifications below. 
               <p  style="font-size:10pt"> (More specifics facilitate identifying target jobs; fewer specifics result in more choices.)</p>  </p></div>
			</div>
			</div>
...
<label style="margin-bottom:0px; margin-top:5px;">Healthcare Industry Sector (see table above)</label> <br>
...
<div class="font1">
<label style="margin-bottom:0px; margin-top:5px;" id="job1">Job Function (see table above)</label>
<input class="form-control  input-lg"  id="jobfunction" name="jobfunction" placeholder="" autocomplete="off">
...
<div class="font1">
 	<label style="margin-bottom:0px; margin-top:5px;">Job Title</label>
	<input class="form-control input-lg" type="text" id="jobtitle" name="jobtitle" autocomplete="off" >
</div>



<div class="font1">
<label style="margin-bottom:0px; margin-top:5px;">Company Name</label>
<input class="form-control input-lg" type="text" id="companyname" name="companyname" autocomplete="off" > 

</div>

<div class="container2" > 

<label class="font1" style="margin-bottom:0px; margin-top:10px;"> Job Location</label>
<div class="font1">
				<label style="margin-bottom:0px; margin-top:1px;">Country</label>
	<form action="#" role="form" class="form-horizontal" id="location" method="post" accept-charset="utf-8">
              
				
       
        <select name="country"  class="form-control countries" id="country" name = "country" >
<option  value="">Select Country</option>
</select>
   <label style="margin-bottom:0px; margin-top:5px;">State</label>

        <select name="state" class="form-control states" id="state"  >
<option  value="">Select State</option>
</select>

 
 <label style="margin-bottom:0px; margin-top:5px;">City</label>
 	...
 	<div class="dropdown" style="width:100%"> <input class="form-control  input-lg"	id="jobtype" name="jobtype" placeholder="" autocomplete="off">
      ...
      <!-- <input class="form-control  input-lg" list="employementtype" id="jobtype" name="jobtype" placeholder="" autocomplete="off">
          <datalist id="employementtype" >      
              <option  onmouseover="jobtype1()" value="Full Time" data-id="01">Full Time</option>
              <option  onmouseover="jobtype2()" value="Part Time" data-id="02">Part Time</option>
              <option  onmouseover="jobtype3()" value="Temporary" data-id="03">Temporary</option>
              <option  onmouseover="jobtype4()" value="Contract" data-id="04">Contract</option>
              <option  onmouseover="jobtype5()" value="Internship" data-id="05">Internship</option>
              <option  onmouseover="jobtype6()" value="Commission" data-id="06">Commission</option>
		...
		<div class="font1">
				...
				<span style="width: 20.5%;"> Minimum: US$ </span> <input class="input-box" type="number"
												id="minimumsalary" min="1000" autocomplete="off"
												name="minimumsalary" placeholder="" style="width: 34.25%;">&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="width: 20.5%;"> Maximum: US$ </span>
				<input class="input-box" type="number"
					   id="maximumsalary" name="maximumsalary"  placeholder="" style="width: 34.25%;">
				</div>      
					<div style="padding-top:10px; display:inline-flex; width: 100%;">
												<div style="padding-top:6px; width:21%;"> Other (e.g., negotiable) </div>
												<div style="width:79%;"><input class="input-box" id="negotiable" autocomplete="off" name="negotiable" placeholder="" style="width:100%;"></div>
                                                </div>
...
<div align="center" valign="middle" class="divselection">
	<div class="font1">
<h4 style=" width:100%; height:50px;background:rgb(34,128,178); text-align:center; vertical-align:middle; padding-top:11px; border-radius: 15px; color:white; margin-top: 10px;" valign="middle"><b>MY QUALIFICATIONS</b></h4> </div>
...
<div class="font1">
	<label style="margin-bottom:0px; margin-top:5px;" id="degree1">Degree</label>
...
<div class="font1">
    <label style="margin-bottom:0px; margin-top:5px;" id="major1">Major in Engineering</label>
...
<div class="font1">
	<label style="margin-bottom:0px; margin-top:5px;">Years of Experience</label>
	   <select class="form-control  input-lg" id="experience"  name="experience" placeholder="Experience (in Years) Required" >
			<option></option>
...
<div  align="center">
	<div class="font1" style="padding-top:15px;">
   	<button  type="submit" class="button1" onclick="search.php">Search</button>
	</div>								
  </div>
...
</div> <!-- Closing Div for width:800px; height:auto; margin-left:auto; margin-right:auto; margin-top:30px;-->
